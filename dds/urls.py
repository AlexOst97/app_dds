...
urlpatterns = [
    # Для Status
    path('status/',
         StatusListAPIView.as_view(),
         name='status-list'),

    path('status/<int:pk>/',
         StatusRetrieveAPIView.as_view(),
    ...
    path('type/<int:pk>/',
         TypeRetrieveAPIView.as_view(),
         name='type-retrieve'),

    path('type/create/',
         TypeCreateAPIView.as_view(),
         name='type-create'),

    path('type/<int:pk>/update/',
         TypeUpdateAPIView.as_view(),
         name='type-update'),

    path('type/<int:pk>/destroy/',
         TypeDestroyAPIView.as_view(),
         name='type-destroy'),
    ...
    path('subcategory/<int:pk>/update/',
         SubcategoryUpdateAPIView.as_view(),
         name='subcategory-update'),

    path('subcategory/<int:pk>/destroy/',
    ...
    # Для CashFlow
    path('cashflow/',
         CashFlowListAPIView.as_view(),
         name='cashflow-list'),

    path('cashflow/<int:pk>/',
         CashFlowRetrieveAPIView.as_view(),
         name='cashflow-retrieve'),

    path('cashflow/create/',
         CashFlowCreateAPIView.as_view(),
         name='cashflow-create'),

    path('cashflow/<int:pk>/update/',
         CashFlowUpdateAPIView.as_view(),
         name='cashflow-update'),

    path('cashflow/<int:pk>/destroy/',
         CashFlowDestroyAPIView.as_view(),
         name='cashflow-destroy'),
